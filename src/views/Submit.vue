...
export default {
  ...
  methods: {
    postEvent: async function () {
      let response = await axios.post('https://armenian-events.herokuapp.com/postEvent', { topic: this.topic, img: this.img, description: this.description, host: this.host, position: this.position, type: this.type })
