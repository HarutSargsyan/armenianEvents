<template>
  <v-container>
    ...
    <v-row>
      <v-col cols="12" sm="6" md="4" lg="3" v-for="techevent in techEvents" :key="techevent.id">
    ...
    <v-row>
      <v-col cols="12" sm="6" md="4" lg="3" v-for="musicevent in musicEvents" :key="musicevent.id">
        <v-card max-width="350" hover outlined shaped to="/">
    ...
    <v-row >
      <v-col cols="12" sm="6" md="4" lg="3" v-for="sportevent in sportEvents" :key="sportevent.id">
        <v-card max-width="350" hover outlined shaped to="/">
